...
namespace ManejoPresupuesto.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        {
            var mensaje = "Proceso concluido. Si el email corresponde con uno de nuestros usuarios, recibirá instrucciones en su correo para reestablecer su contraseña";
            ViewBag.Mensaje = mensaje;
            ModelState.Clear();
